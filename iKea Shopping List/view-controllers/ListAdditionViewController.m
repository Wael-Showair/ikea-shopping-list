...
- (UITableViewCell *)tableView:(UITableView *)tableView
  ...
  TextInputTableViewCell* cell = [tableView dequeueReusableCellWithIdentifier:NEW_LIST_INFO_CELL_ID];
...
- (IBAction)onTapDone:(id)sender {
   ...
   */
  [self.listInfoCreationDelegate listInfoDidCreatedWithTitle:self.listNameTextField.text];
