...
-(void)onChangeDeviceOrientation{
    ...
    NSString* verticalConstraintExpression = [NSString stringWithFormat: @"V:|[topGuide][navigationBar(%f)]", self.frame.size.height];
              ...
              RightBtnSelector:(SEL) rightAction
{
    ...
    if (self) {
        ...
        if(nil != rightAction){
            UIBarButtonItem* rightBtn = [[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemDone target:self.hostingViewController action:rightAction];
